        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 59, "112", 10, true, 1107, "Votes", 1, 110, 57 },
                    { 108, "104", 10, true, 1311, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 150, "Add Project Root Command", 4, "", true, "CmdAddProjectRoot", 120, 20 },
                    { 152, "Add Sub Folder Command", 4, "", true, "CmdAddSubFolder", 120, 21 },
                    { 154, "Add Solution Command", 4, "", true, "CmdAddSolution", 120, 22 },
                    { 156, "Add Solution Import Command", 4, "", true, "CmdAddSolutionImport", 120, 23 },
                    { 158, "Add Md File Command", 4, "", true, "CmdAddMdFile", 120, 24 },
                    { 160, "Add Html File Command", 4, "", true, "CmdAddHtmlFile", 120, 25 },
                    { 162, "Add Config File Command", 4, "", true, "CmdAddConfigFile", 120, 26 },
                    { 164, "Add Library Command", 4, "", true, "CmdAddLibrary", 120, 27 },
                    { 166, "Add Namespace Command", 4, "", true, "CmdAddNamespace", 120, 28 },
                    { 168, "Add Class Command", 4, "", true, "CmdAddClass", 120, 29 },
                    { 170, "Add Class Import Command", 4, "", true, "CmdAddClassImport", 120, 30 },
                    { 172, "Add Class Property Command", 4, "", true, "CmdAddClassProperty", 120, 31 },
                    { 174, "Add Class Method Command", 4, "", true, "CmdAddClassMethod", 120, 32 },
                    { 176, "Add Class Method Param Command", 4, "", true, "CmdAddClassMethodParam", 120, 33 },
                    { 178, "Add Entity Class Command", 4, "", true, "CmdAddEntityClass", 120, 34 },
                    { 180, "Add Entity Class Import Command", 4, "", true, "CmdAddEntityClassImport", 120, 35 },
                    { 182, "Add Entity Property Command", 4, "", true, "CmdAddEntityProperty", 120, 36 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 58, "104", 10, true, 1101, "Results", 1, 100, 57 },
                    { 60, "", 14, true, 1110, "RelativeFolder", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 61, "104", 10, true, 1111, "Results", 1, 100, 57 },
                    { 62, "", 5, true, 1120, "FilePath", 2, null, 54 },
                    { 63, ".md", 4, true, 1120, "FileExt", 1, null, 54 },
                    { 65, "", 5, true, 1130, "FilePath", 2, null, 54 },
                    { 66, ".html", 4, true, 1130, "FileExt", 1, null, 54 },
                    { 68, "", 5, true, 1140, "FilePath", 2, null, 54 },
                    { 69, ".json", 4, true, 1140, "FileExt", 1, null, 54 },
                    { 71, "", 5, true, 1150, "FilePath", 2, null, 54 },
                    { 72, ".png", 4, true, 1150, "FileExt", 1, null, 54 },
                    { 74, "", 5, true, 1160, "FilePath", 3, null, 54 },
                    { 75, ".sln", 1, true, 1160, "FileExt", 2, null, 54 },
                    { 76, "", 4, true, 1160, "SlnGuid", 1, null, 54 },
                    { 80, "", 4, true, 1200, "FilePath", 11, null, 54 },
                    { 81, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 82, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 83, "1", 2, true, 1200, "IsNullable", 8, null, 55 },
                    { 84, "1", 2, true, 1200, "ImplicitUsing", 7, null, 55 },
                    { 85, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 86, "1.0.0.0", 4, true, 1200, "AssemblyVersion", 5, null, 54 },
                    { 87, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 88, "0", 2, true, 1200, "IsTestLib", 3, null, 55 },
                    { 89, ".csproj", 1, true, 1200, "FileExt", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 64, "104", 10, true, 1121, "Results", 1, 100, 57 },
                    { 67, "104", 10, true, 1131, "Results", 1, 100, 57 },
                    { 70, "104", 10, true, 1141, "Results", 1, 100, 57 },
                    { 73, "104", 10, true, 1151, "Results", 1, 100, 57 },
                    { 77, "104", 10, true, 1161, "Results", 1, 100, 57 },
                    { 78, "", 10, true, 1162, "RegisterObj", 3, 1200, 57 },
                    { 79, "", 4, true, 1162, "ProjectGuid", 2, null, 54 },
                    { 90, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 91, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 92, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 93, "", 4, true, 1210, "PrivateAssets", 4, null, 54 },
                    { 94, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 95, "", 10, true, 1220, "LibInclude", 1, 1200, 57 },
                    { 96, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 97, ".cs", 1, true, 1300, "FileExt", 6, null, 54 },
                    { 98, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 99, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 100, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 110, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 111, "", 4, true, 1400, "Namespace", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 101, "104", 10, true, 1301, "Results", 1, 100, 57 },
                    { 102, "42", 10, true, 1302, "LifetimeScope", 3, 40, 57 },
                    { 103, "", 10, true, 1302, "RegisterObj", 2, 1500, 57 },
                    { 104, "", 2, true, 1302, "RegisterIntf", 1, null, 55 },
                    { 105, "", 4, true, 1310, "FilePath", 3, null, 54 },
                    { 106, ".cs", 4, true, 1310, "FileExt", 2, null, 54 },
                    { 107, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 112, "104", 10, true, 1401, "Results", 1, 100, 57 },
                    { 113, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 },
                    { 114, ".cs", 4, true, 1450, "FileExt", 16, null, 54 },
                    { 115, "", 4, true, 1450, "FilePath", 15, null, 54 },
                    { 116, "", 4, true, 1450, "Namespace", 14, null, 54 },
                    { 117, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 118, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    { 120, "91", 10, true, 1460, "AccessModifier", 17, 90, 57 },
                    { 121, ".cs", 4, true, 1460, "FileExt", 16, null, 54 },
                    { 122, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 123, "", 4, true, 1460, "Namespace", 14, null, 54 },
                    { 124, "", 10, true, 1460, "BaseType", 13, 50, 57 },
                    { 125, "", 2, true, 1460, "GenInterface", 12, null, 55 },
                    { 127, "0", 2, true, 1500, "TestClass", 19, null, 55 },
                    { 128, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 129, ".cs", 1, true, 1500, "FileExt", 17, null, 54 },
                    { 130, "", 4, true, 1500, "FilePath", 16, null, 54 },
                    { 131, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 132, "", 10, true, 1500, "BaseType", 14, 1500, 57 },
                    { 133, "", 2, true, 1500, "GenInterface", 13, null, 55 },
                    { 134, "", 2, true, 1500, "RegisterDI", 12, null, 55 },
                    { 135, "0", 2, true, 1500, "IsStatic", 11, null, 55 },
                    { 160, ".cs", 1, true, 1600, "FileExt", 17, null, 54 },
                    { 161, "", 4, true, 1600, "FilePath", 16, null, 54 },
                    { 162, "", 4, true, 1600, "Namespace", 15, null, 54 },
                    { 163, "dbo", 4, true, 1600, "DbSchema", 14, null, 54 },
                    { 164, "", 4, true, 1600, "DbTableName", 13, null, 54 },
                    { 186, ".cs", 1, true, 1700, "FileExt", 16, null, 54 },
                    { 187, "", 4, true, 1700, "FilePath", 15, null, 54 },
                    { 188, "", 4, true, 1700, "Namespace", 14, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 109, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 119, "104", 10, true, 1451, "Results", 1, 100, 57 },
                    { 126, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 136, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 137, "", 10, true, 1502, "ImportObj", 4, 1500, 57 },
                    { 138, "", 2, true, 1502, "UseIntf", 3, null, 55 },
                    { 139, "57", 10, true, 1510, "PropType", 5, 50, 57 },
                    { 140, "", 10, true, 1510, "PropClass", 4, 1500, 57 },
                    { 141, "1", 2, true, 1510, "IsNullable", 3, null, 55 },
                    { 142, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    { 144, "32", 10, true, 1520, "TestMethod", 19, 31, 57 },
                    { 145, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    { 146, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 147, "", 10, true, 1520, "ReturnClass", 16, 1500, 57 },
                    { 148, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 149, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 150, "0", 2, true, 1520, "IsVirtual", 13, null, 55 },
                    { 151, "0", 2, true, 1520, "IsStatic", 12, null, 55 },
                    { 152, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 153, "0", 2, true, 1520, "IsSealed", 10, null, 55 },
                    { 165, "104", 10, true, 1601, "Results", 1, 100, 57 },
                    { 166, "", 10, true, 1602, "ImportObj", 4, 1500, 57 },
                    { 167, "", 2, true, 1602, "UseIntf", 3, null, 55 },
                    { 168, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 169, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 170, "1", 2, true, 1610, "HasSetter", 6, null, 55 },
                    { 171, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 172, "0", 2, true, 1610, "IsPrimaryKey", 4, null, 55 },
                    { 173, "-1", 3, true, 1610, "MaxSize", 3, null, 57 },
                    { 180, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 181, "", 10, true, 1630, "ForeignKey", 6, 1610, 57 },
                    { 182, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 183, "1", 2, true, 1630, "IsNullable", 4, null, 55 },
                    { 184, "", 4, true, 1630, "InverseNav", 3, null, 54 },
                    { 189, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 190, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 191, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 192, "", 10, true, 1720, "PropClass", 2, 1500, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 143, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 154, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 155, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 156, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 157, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 158, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 174, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 175, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 176, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 177, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 178, "1", 2, true, 1620, "IsNullable", 3, null, 55 },
                    { 185, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 193, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 194, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 195, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 196, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 197, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 198, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 199, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 200, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 201, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 202, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 203, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 204, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 205, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 206, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 207, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 208, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 209, "0", 2, true, 1830, "IsSealed", 10, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 159, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 179, "104", 10, true, 1621, "Results", 1, 100, 57 },
                    { 210, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 211, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 212, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 213, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 214, "0", 2, true, 1840, "UseThis", 2, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 215, "104", 10, true, 1841, "Results", 1, 100, 57 });
