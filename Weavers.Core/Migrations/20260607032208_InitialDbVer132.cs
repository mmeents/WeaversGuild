...
{
    /// <inheritdoc />
    public partial class InitialDbVer132 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 199, "Desk Roles", 10, "", true, "DeskRoles", null, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 50, "112", 10, true, 1107, "Votes", 1, 110, 57 },
                    { 99, "104", 10, true, 1311, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 144, "Add Digital Operator Command", -1, "", true, "CmdAddDigitalOperatior", 120, 13 },
                    { 146, "Add Org Folder Command", -1, "", true, "CmdAddOrgFolder", 120, 14 },
                    { 148, "Add Org File Command", -1, "", true, "CmdAddOrgFile", 120, 15 },
                    { 150, "Add Project Root Command", 4, "", true, "CmdAddProjectRoot", 120, 16 },
                    { 152, "Add Sub Folder Command", 4, "", true, "CmdAddSubFolder", 120, 17 },
                    { 154, "Add Solution Command", 4, "", true, "CmdAddSolution", 120, 18 },
                    { 156, "Add Solution Import Command", 4, "", true, "CmdAddSolutionImport", 120, 19 },
                    { 158, "Add Md File Command", 4, "", true, "CmdAddMdFile", 120, 20 },
                    { 160, "Add Html File Command", 4, "", true, "CmdAddHtmlFile", 120, 21 },
                    { 162, "Add Config File Command", 4, "", true, "CmdAddConfigFile", 120, 22 },
                    { 164, "Add Library Command", 4, "", true, "CmdAddLibrary", 120, 23 },
                    { 166, "Add Namespace Command", 4, "", true, "CmdAddNamespace", 120, 24 },
                    { 168, "Add Class Command", 4, "", true, "CmdAddClass", 120, 25 },
                    { 170, "Add Class Import Command", 4, "", true, "CmdAddClassImport", 120, 26 },
                    { 172, "Add Class Property Command", 4, "", true, "CmdAddClassProperty", 120, 27 },
                    { 174, "Add Class Method Command", 4, "", true, "CmdAddClassMethod", 120, 28 },
                    { 176, "Add Class Method Param Command", 4, "", true, "CmdAddClassMethodParam", 120, 29 },
                    { 178, "Add Entity Class Command", 4, "", true, "CmdAddEntityClass", 120, 30 },
                    { 180, "Add Entity Class Import Command", 4, "", true, "CmdAddEntityClassImport", 120, 31 },
                    { 182, "Add Entity Property Command", 4, "", true, "CmdAddEntityProperty", 120, 32 },
                    { 200, "None", -1, "", true, "RoleNone", 199, 1 },
                    { 201, "Research", -1, "", true, "RoleResearch", 199, 2 },
                    { 202, "Review Research", -1, "", true, "RoleReviewResearch", 199, 3 },
                    { 203, "Design", -1, "", true, "RoleDesign", 199, 4 },
                    { 204, "Review Design", -1, "", true, "RoleReviewDesign", 199, 5 },
                    { 205, "Plan", -1, "", true, "RolePlan", 199, 6 },
                    { 206, "Review Plan", -1, "", true, "RoleReviewPlan", 199, 7 },
                    { 207, "Building Out", -1, "", true, "RoleBuildingOut", 199, 8 },
                    { 208, "Review Build Out", -1, "", true, "RoleReviewBuildOut", 199, 9 },
                    { 209, "Testing", -1, "", true, "RoleTesting", 199, 10 },
                    { 210, "Review Tests", -1, "", true, "RoleReviewTests", 199, 11 },
                    { 211, "Document", -1, "", true, "RoleDocument", 199, 12 },
                    { 212, "Review Document", -1, "", true, "RoleReviewDocument", 199, 13 },
                    { 213, "Packaging", -1, "", true, "RolePackaging", 199, 14 },
                    { 214, "Review Packaging", -1, "", true, "RoleReviewPackaging", 199, 15 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 19, "116", 10, true, 1040, "FloorStatus", 9, 115, 57 },
                    { 20, "", 14, true, 1040, "RelativeFolder", 1, null, 54 },
                    { 45, "", 14, true, 1060, "RelativeFolder", 1, null, 54 },
                    { 47, "", 13, true, 1100, "RelativeFolder", 2, null, 54 },
                    { 48, "", 4, true, 1100, "RepoUrl", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 17, "", 12, true, 1035, "SysPrompt", 7, null, 54 },
                    { 18, "", 5, true, 1035, "FilePath", 1, null, 54 },
                    { 21, "1", 2, true, 1043, "Enabled", 11, null, 55 },
                    { 22, "", 14, true, 1043, "RelativeFolder", 1, null, 54 },
                    { 23, "0", 10, true, 1045, "DeskRole", 12, 199, 57 },
                    { 24, "0", 2, true, 1045, "Enabled", 11, null, 55 },
                    { 25, "", 10, true, 1045, "Operator", 10, 1035, 57 },
                    { 26, "", 17, true, 1045, "SysPrompt", 9, null, 54 },
                    { 27, "", 10, true, 1045, "OnSuccessTo", 7, 1045, 57 },
                    { 28, "", 10, true, 1045, "OnFailTo", 6, 1045, 57 },
                    { 29, "", 10, true, 1045, "OnPushbackTo", 5, 1045, 57 },
                    { 30, "3", 3, true, 1045, "MaxAttempts", 4, null, 57 },
                    { 32, "", 5, true, 1045, "FilePath", 1, null, 54 },
                    { 46, "", 5, true, 1065, "FilePath", 1, null, 54 },
                    { 49, "104", 10, true, 1101, "Results", 1, 100, 57 },
                    { 51, "", 14, true, 1110, "RelativeFolder", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 16, "", 10, true, 1035, "Presence", 8, 1015, 57 },
                    { 31, "", 10, true, 1045, "CurrentTodo", 2, 1050, 57 },
                    { 33, "0", 2, true, 1050, "Ready", 12, null, 55 },
                    { 34, "221", 10, true, 1050, "Status", 11, 220, 57 },
                    { 35, "", 16, true, 1050, "RefItem", 10, null, 57 },
                    { 36, "", 17, true, 1050, "UserPrompt", 9, null, 54 },
                    { 37, "", 10, true, 1050, "FromTodo", 8, 1050, 57 },
                    { 38, "", 12, true, 1050, "CloseReason", 8, null, 54 },
                    { 52, "104", 10, true, 1111, "Results", 1, 100, 57 },
                    { 53, "", 5, true, 1120, "FilePath", 2, null, 54 },
                    { 54, ".md", 4, true, 1120, "FileExt", 1, null, 54 },
                    { 56, "", 5, true, 1130, "FilePath", 2, null, 54 },
                    { 57, ".html", 4, true, 1130, "FileExt", 1, null, 54 },
                    { 59, "", 5, true, 1140, "FilePath", 2, null, 54 },
                    { 60, ".json", 4, true, 1140, "FileExt", 1, null, 54 },
                    { 62, "", 5, true, 1150, "FilePath", 2, null, 54 },
                    { 63, ".png", 4, true, 1150, "FileExt", 1, null, 54 },
                    { 65, "", 5, true, 1160, "FilePath", 3, null, 54 },
                    { 66, ".sln", 1, true, 1160, "FileExt", 2, null, 54 },
                    { 67, "", 4, true, 1160, "SlnGuid", 1, null, 54 },
                    { 71, "", 4, true, 1200, "FilePath", 11, null, 54 },
                    { 72, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 73, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 74, "1", 2, true, 1200, "IsNullable", 8, null, 55 },
                    { 75, "1", 2, true, 1200, "ImplicitUsing", 7, null, 55 },
                    { 76, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 77, "1.0.0.0", 4, true, 1200, "AssemblyVersion", 5, null, 54 },
                    { 78, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 79, "0", 2, true, 1200, "IsTestLib", 3, null, 55 },
                    { 80, ".csproj", 1, true, 1200, "FileExt", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 39, "231", 10, true, 1055, "Status", 10, 230, 57 },
                    { 40, "", 10, true, 1055, "NextTodo", 9, 1050, 57 },
                    { 41, "", 12, true, 1055, "SysPrompt", 8, null, 54 },
                    { 42, "", 12, true, 1055, "UserPrompt", 7, null, 54 },
                    { 43, "", 12, true, 1055, "Response", 6, null, 54 },
                    { 44, "", 10, true, 1055, "Operator", 5, 1035, 57 },
                    { 55, "104", 10, true, 1121, "Results", 1, 100, 57 },
                    { 58, "104", 10, true, 1131, "Results", 1, 100, 57 },
                    { 61, "104", 10, true, 1141, "Results", 1, 100, 57 },
                    { 64, "104", 10, true, 1151, "Results", 1, 100, 57 },
                    { 68, "104", 10, true, 1161, "Results", 1, 100, 57 },
                    { 69, "", 10, true, 1162, "RegisterObj", 3, 1200, 57 },
                    { 70, "", 4, true, 1162, "ProjectGuid", 2, null, 54 },
                    { 81, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 82, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 83, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 84, "", 4, true, 1210, "PrivateAssets", 4, null, 54 },
                    { 85, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 86, "", 10, true, 1220, "LibInclude", 1, 1200, 57 },
                    { 87, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 88, ".cs", 1, true, 1300, "FileExt", 6, null, 54 },
                    { 89, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 90, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 91, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 101, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 102, "", 4, true, 1400, "Namespace", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 92, "104", 10, true, 1301, "Results", 1, 100, 57 },
                    { 93, "42", 10, true, 1302, "LifetimeScope", 3, 40, 57 },
                    { 94, "", 10, true, 1302, "RegisterObj", 2, 1500, 57 },
                    { 95, "", 2, true, 1302, "RegisterIntf", 1, null, 55 },
                    { 96, "", 4, true, 1310, "FilePath", 3, null, 54 },
                    { 97, ".cs", 4, true, 1310, "FileExt", 2, null, 54 },
                    { 98, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 103, "104", 10, true, 1401, "Results", 1, 100, 57 },
                    { 104, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 },
                    { 105, ".cs", 4, true, 1450, "FileExt", 16, null, 54 },
                    { 106, "", 4, true, 1450, "FilePath", 15, null, 54 },
                    { 107, "", 4, true, 1450, "Namespace", 14, null, 54 },
                    { 108, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 109, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    { 111, "91", 10, true, 1460, "AccessModifier", 17, 90, 57 },
                    { 112, ".cs", 4, true, 1460, "FileExt", 16, null, 54 },
                    { 113, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 114, "", 4, true, 1460, "Namespace", 14, null, 54 },
                    { 115, "", 10, true, 1460, "BaseType", 13, 50, 57 },
                    { 116, "", 2, true, 1460, "GenInterface", 12, null, 55 },
                    { 118, "0", 2, true, 1500, "TestClass", 19, null, 55 },
                    { 119, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 120, ".cs", 1, true, 1500, "FileExt", 17, null, 54 },
                    { 121, "", 4, true, 1500, "FilePath", 16, null, 54 },
                    { 122, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 123, "", 10, true, 1500, "BaseType", 14, 1500, 57 },
                    { 124, "", 2, true, 1500, "GenInterface", 13, null, 55 },
                    { 125, "", 2, true, 1500, "RegisterDI", 12, null, 55 },
                    { 126, "0", 2, true, 1500, "IsStatic", 11, null, 55 },
                    { 151, ".cs", 1, true, 1600, "FileExt", 17, null, 54 },
                    { 152, "", 4, true, 1600, "FilePath", 16, null, 54 },
                    { 153, "", 4, true, 1600, "Namespace", 15, null, 54 },
                    { 154, "dbo", 4, true, 1600, "DbSchema", 14, null, 54 },
                    { 155, "", 4, true, 1600, "DbTableName", 13, null, 54 },
                    { 177, ".cs", 1, true, 1700, "FileExt", 16, null, 54 },
                    { 178, "", 4, true, 1700, "FilePath", 15, null, 54 },
                    { 179, "", 4, true, 1700, "Namespace", 14, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 100, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 110, "104", 10, true, 1451, "Results", 1, 100, 57 },
                    { 117, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 127, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 128, "", 10, true, 1502, "ImportObj", 4, 1500, 57 },
                    { 129, "", 2, true, 1502, "UseIntf", 3, null, 55 },
                    { 130, "57", 10, true, 1510, "PropType", 5, 50, 57 },
                    { 131, "", 10, true, 1510, "PropClass", 4, 1500, 57 },
                    { 132, "1", 2, true, 1510, "IsNullable", 3, null, 55 },
                    { 133, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    { 135, "32", 10, true, 1520, "TestMethod", 19, 31, 57 },
                    { 136, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    { 137, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 138, "", 10, true, 1520, "ReturnClass", 16, 1500, 57 },
                    { 139, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 140, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 141, "0", 2, true, 1520, "IsVirtual", 13, null, 55 },
                    { 142, "0", 2, true, 1520, "IsStatic", 12, null, 55 },
                    { 143, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 144, "0", 2, true, 1520, "IsSealed", 10, null, 55 },
                    { 156, "104", 10, true, 1601, "Results", 1, 100, 57 },
                    { 157, "", 10, true, 1602, "ImportObj", 4, 1500, 57 },
                    { 158, "", 2, true, 1602, "UseIntf", 3, null, 55 },
                    { 159, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 160, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 161, "1", 2, true, 1610, "HasSetter", 6, null, 55 },
                    { 162, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 163, "0", 2, true, 1610, "IsPrimaryKey", 4, null, 55 },
                    { 164, "-1", 3, true, 1610, "MaxSize", 3, null, 57 },
                    { 171, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 172, "", 10, true, 1630, "ForeignKey", 6, 1610, 57 },
                    { 173, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 174, "1", 2, true, 1630, "IsNullable", 4, null, 55 },
                    { 175, "", 4, true, 1630, "InverseNav", 3, null, 54 },
                    { 180, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 181, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 182, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 183, "", 10, true, 1720, "PropClass", 2, 1500, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 134, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 145, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 146, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 147, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 148, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 149, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 165, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 166, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 167, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 168, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 169, "1", 2, true, 1620, "IsNullable", 3, null, 55 },
                    { 176, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 184, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 185, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 186, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 187, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 188, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 189, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 190, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 191, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 192, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 193, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 194, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 195, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 196, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 197, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 198, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 199, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 200, "0", 2, true, 1830, "IsSealed", 10, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 150, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 170, "104", 10, true, 1621, "Results", 1, 100, 57 },
                    { 201, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 202, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 203, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 204, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 205, "0", 2, true, 1840, "UseThis", 2, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 206, "104", 10, true, 1841, "Results", 1, 100, 57 });
