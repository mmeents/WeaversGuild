...
{
    /// <inheritdoc />
    public partial class InitialDbVer134 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 51, "112", 10, true, 1107, "Votes", 1, 110, 57 },
                    { 100, "104", 10, true, 1311, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 201, "Org Doc Writer", -1, "", true, "RoleOrgDocWriter", 199, 2 },
                    { 202, "Review Org Doc Writer", -1, "", true, "RoleReviewOrgDocWriter", 199, 3 },
                    { 203, "Org Researcher", -1, "", true, "RoleOrgResearcher", 199, 4 },
                    { 204, "Review Org Researcher", -1, "", true, "RoleReviewOrgResearcher", 199, 5 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 46, "", 14, true, 1060, "RelativeFolder", 1, null, 54 },
                    { 48, "", 13, true, 1100, "RelativeFolder", 2, null, 54 },
                    { 49, "", 4, true, 1100, "RepoUrl", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 47, "", 5, true, 1065, "FilePath", 1, null, 54 },
                    { 50, "104", 10, true, 1101, "Results", 1, 100, 57 },
                    { 52, "", 14, true, 1110, "RelativeFolder", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 38, "", 12, true, 1050, "CloseReason", 7, null, 54 },
                    { 39, "1", 3, true, 1050, "TodoDepth", 6, null, 57 },
                    { 53, "104", 10, true, 1111, "Results", 1, 100, 57 },
                    { 54, "", 5, true, 1120, "FilePath", 2, null, 54 },
                    { 55, ".md", 4, true, 1120, "FileExt", 1, null, 54 },
                    { 57, "", 5, true, 1130, "FilePath", 2, null, 54 },
                    { 58, ".html", 4, true, 1130, "FileExt", 1, null, 54 },
                    { 60, "", 5, true, 1140, "FilePath", 2, null, 54 },
                    { 61, ".json", 4, true, 1140, "FileExt", 1, null, 54 },
                    { 63, "", 5, true, 1150, "FilePath", 2, null, 54 },
                    { 64, ".png", 4, true, 1150, "FileExt", 1, null, 54 },
                    { 66, "", 5, true, 1160, "FilePath", 3, null, 54 },
                    { 67, ".sln", 1, true, 1160, "FileExt", 2, null, 54 },
                    { 68, "", 4, true, 1160, "SlnGuid", 1, null, 54 },
                    { 72, "", 4, true, 1200, "FilePath", 11, null, 54 },
                    { 73, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 74, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 75, "1", 2, true, 1200, "IsNullable", 8, null, 55 },
                    { 76, "1", 2, true, 1200, "ImplicitUsing", 7, null, 55 },
                    { 77, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 78, "1.0.0.0", 4, true, 1200, "AssemblyVersion", 5, null, 54 },
                    { 79, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 80, "0", 2, true, 1200, "IsTestLib", 3, null, 55 },
                    { 81, ".csproj", 1, true, 1200, "FileExt", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 40, "231", 10, true, 1055, "Status", 10, 230, 57 },
                    { 41, "", 10, true, 1055, "NextTodo", 9, 1050, 57 },
                    { 42, "", 12, true, 1055, "SysPrompt", 8, null, 54 },
                    { 43, "", 12, true, 1055, "UserPrompt", 7, null, 54 },
                    { 44, "", 12, true, 1055, "Response", 6, null, 54 },
                    { 45, "", 10, true, 1055, "Operator", 5, 1035, 57 },
                    { 56, "104", 10, true, 1121, "Results", 1, 100, 57 },
                    { 59, "104", 10, true, 1131, "Results", 1, 100, 57 },
                    { 62, "104", 10, true, 1141, "Results", 1, 100, 57 },
                    { 65, "104", 10, true, 1151, "Results", 1, 100, 57 },
                    { 69, "104", 10, true, 1161, "Results", 1, 100, 57 },
                    { 70, "", 10, true, 1162, "RegisterObj", 3, 1200, 57 },
                    { 71, "", 4, true, 1162, "ProjectGuid", 2, null, 54 },
                    { 82, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 83, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 84, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 85, "", 4, true, 1210, "PrivateAssets", 4, null, 54 },
                    { 86, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 87, "", 10, true, 1220, "LibInclude", 1, 1200, 57 },
                    { 88, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 89, ".cs", 1, true, 1300, "FileExt", 6, null, 54 },
                    { 90, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 91, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 92, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 102, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 103, "", 4, true, 1400, "Namespace", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 93, "104", 10, true, 1301, "Results", 1, 100, 57 },
                    { 94, "42", 10, true, 1302, "LifetimeScope", 3, 40, 57 },
                    { 95, "", 10, true, 1302, "RegisterObj", 2, 1500, 57 },
                    { 96, "", 2, true, 1302, "RegisterIntf", 1, null, 55 },
                    { 97, "", 4, true, 1310, "FilePath", 3, null, 54 },
                    { 98, ".cs", 4, true, 1310, "FileExt", 2, null, 54 },
                    { 99, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 104, "104", 10, true, 1401, "Results", 1, 100, 57 },
                    { 105, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 },
                    { 106, ".cs", 4, true, 1450, "FileExt", 16, null, 54 },
                    { 107, "", 4, true, 1450, "FilePath", 15, null, 54 },
                    { 108, "", 4, true, 1450, "Namespace", 14, null, 54 },
                    { 109, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 110, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    { 112, "91", 10, true, 1460, "AccessModifier", 17, 90, 57 },
                    { 113, ".cs", 4, true, 1460, "FileExt", 16, null, 54 },
                    { 114, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 115, "", 4, true, 1460, "Namespace", 14, null, 54 },
                    { 116, "", 10, true, 1460, "BaseType", 13, 50, 57 },
                    { 117, "", 2, true, 1460, "GenInterface", 12, null, 55 },
                    { 119, "0", 2, true, 1500, "TestClass", 19, null, 55 },
                    { 120, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 121, ".cs", 1, true, 1500, "FileExt", 17, null, 54 },
                    { 122, "", 4, true, 1500, "FilePath", 16, null, 54 },
                    { 123, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 124, "", 10, true, 1500, "BaseType", 14, 1500, 57 },
                    { 125, "", 2, true, 1500, "GenInterface", 13, null, 55 },
                    { 126, "", 2, true, 1500, "RegisterDI", 12, null, 55 },
                    { 127, "0", 2, true, 1500, "IsStatic", 11, null, 55 },
                    { 152, ".cs", 1, true, 1600, "FileExt", 17, null, 54 },
                    { 153, "", 4, true, 1600, "FilePath", 16, null, 54 },
                    { 154, "", 4, true, 1600, "Namespace", 15, null, 54 },
                    { 155, "dbo", 4, true, 1600, "DbSchema", 14, null, 54 },
                    { 156, "", 4, true, 1600, "DbTableName", 13, null, 54 },
                    { 178, ".cs", 1, true, 1700, "FileExt", 16, null, 54 },
                    { 179, "", 4, true, 1700, "FilePath", 15, null, 54 },
                    { 180, "", 4, true, 1700, "Namespace", 14, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 101, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 111, "104", 10, true, 1451, "Results", 1, 100, 57 },
                    { 118, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 128, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 129, "", 10, true, 1502, "ImportObj", 4, 1500, 57 },
                    { 130, "", 2, true, 1502, "UseIntf", 3, null, 55 },
                    { 131, "57", 10, true, 1510, "PropType", 5, 50, 57 },
                    { 132, "", 10, true, 1510, "PropClass", 4, 1500, 57 },
                    { 133, "1", 2, true, 1510, "IsNullable", 3, null, 55 },
                    { 134, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    { 136, "32", 10, true, 1520, "TestMethod", 19, 31, 57 },
                    { 137, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    { 138, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 139, "", 10, true, 1520, "ReturnClass", 16, 1500, 57 },
                    { 140, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 141, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 142, "0", 2, true, 1520, "IsVirtual", 13, null, 55 },
                    { 143, "0", 2, true, 1520, "IsStatic", 12, null, 55 },
                    { 144, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 145, "0", 2, true, 1520, "IsSealed", 10, null, 55 },
                    { 157, "104", 10, true, 1601, "Results", 1, 100, 57 },
                    { 158, "", 10, true, 1602, "ImportObj", 4, 1500, 57 },
                    { 159, "", 2, true, 1602, "UseIntf", 3, null, 55 },
                    { 160, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 161, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 162, "1", 2, true, 1610, "HasSetter", 6, null, 55 },
                    { 163, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 164, "0", 2, true, 1610, "IsPrimaryKey", 4, null, 55 },
                    { 165, "-1", 3, true, 1610, "MaxSize", 3, null, 57 },
                    { 172, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 173, "", 10, true, 1630, "ForeignKey", 6, 1610, 57 },
                    { 174, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 175, "1", 2, true, 1630, "IsNullable", 4, null, 55 },
                    { 176, "", 4, true, 1630, "InverseNav", 3, null, 54 },
                    { 181, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 182, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 183, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 184, "", 10, true, 1720, "PropClass", 2, 1500, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 135, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 146, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 147, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 148, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 149, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 150, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 166, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 167, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 168, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 169, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 170, "1", 2, true, 1620, "IsNullable", 3, null, 55 },
                    { 177, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 185, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 186, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 187, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 188, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 189, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 190, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 191, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 192, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 193, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 194, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 195, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 196, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 197, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 198, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 199, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 200, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 201, "0", 2, true, 1830, "IsSealed", 10, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 151, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 171, "104", 10, true, 1621, "Results", 1, 100, 57 },
                    { 202, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 203, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 204, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 205, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 206, "0", 2, true, 1840, "UseThis", 2, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 207, "104", 10, true, 1841, "Results", 1, 100, 57 });
