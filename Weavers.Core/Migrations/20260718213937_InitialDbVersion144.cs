...
{
    /// <inheritdoc />
    public partial class InitialDbVersion144 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 79, "112", 10, true, 1107, "Votes", 1, 110, 57 },
                    { 128, "104", 10, true, 1311, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 160, "Add Solution Command", 4, "", true, "CmdAddSolution", 120, 32 },
                    { 161, "Add Solution Import Command", 4, "", true, "CmdAddSolutionImport", 120, 33 },
                    { 162, "Add Md File Command", 4, "", true, "CmdAddMdFile", 120, 34 },
                    { 163, "Add Html File Command", 4, "", true, "CmdAddHtmlFile", 120, 35 },
                    { 164, "Add Config File Command", 4, "", true, "CmdAddConfigFile", 120, 36 },
                    { 165, "Add Library Command", 4, "", true, "CmdAddLibrary", 120, 37 },
                    { 166, "Add Namespace Command", 4, "", true, "CmdAddNamespace", 120, 38 },
                    { 168, "Add Class Command", 4, "", true, "CmdAddClass", 120, 39 },
                    { 170, "Add Class Import Command", 4, "", true, "CmdAddClassImport", 120, 40 },
                    { 172, "Add Class Property Command", 4, "", true, "CmdAddClassProperty", 120, 41 },
                    { 174, "Add Class Method Command", 4, "", true, "CmdAddClassMethod", 120, 42 },
                    { 176, "Add Class Method Param Command", 4, "", true, "CmdAddClassMethodParam", 120, 43 },
                    { 178, "Add Entity Class Command", 4, "", true, "CmdAddEntityClass", 120, 44 },
                    { 180, "Add Entity Class Import Command", 4, "", true, "CmdAddEntityClassImport", 120, 45 },
                    { 182, "Add Entity Property Command", 4, "", true, "CmdAddEntityProperty", 120, 46 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 57, "", 12, true, 1070, "GuildNotes", 2, null, 54 },
                    { 76, "", 13, true, 1100, "RelativeFolder", 2, null, 54 },
                    { 77, "", 4, true, 1100, "RepoUrl", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 58, "", 14, true, 1075, "RelativeFolder", 10, null, 54 },
                    { 59, "", 4, true, 1075, "ChannelUrl", 5, null, 54 },
                    { 60, "0", 2, true, 1075, "DoResync", 3, null, 55 },
                    { 61, "", 12, true, 1075, "GuildNotes", 2, null, 54 },
                    { 78, "104", 10, true, 1101, "Results", 1, 100, 57 },
                    { 80, "", 14, true, 1110, "RelativeFolder", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 62, "", 5, true, 1076, "FilePath", 10, null, 54 },
                    { 63, "", 4, true, 1076, "HasUrl", 8, null, 54 },
                    { 64, "261", 10, true, 1076, "ResolveState", 7, 260, 57 },
                    { 65, "0", 2, true, 1076, "ResolveLink", 5, null, 55 },
                    { 66, "0", 2, true, 1076, "ExtractLink", 3, null, 55 },
                    { 67, "", 12, true, 1076, "GuildNotes", 2, null, 54 },
                    { 68, "20", 3, true, 1076, "MaxLinks", 1, null, 57 },
                    { 81, "104", 10, true, 1111, "Results", 1, 100, 57 },
                    { 82, "", 5, true, 1120, "FilePath", 2, null, 54 },
                    { 83, ".md", 4, true, 1120, "FileExt", 1, null, 54 },
                    { 85, "", 5, true, 1130, "FilePath", 2, null, 54 },
                    { 86, ".html", 4, true, 1130, "FileExt", 1, null, 54 },
                    { 88, "", 5, true, 1140, "FilePath", 2, null, 54 },
                    { 89, ".json", 4, true, 1140, "FileExt", 1, null, 54 },
                    { 91, "", 5, true, 1150, "FilePath", 2, null, 54 },
                    { 92, ".png", 4, true, 1150, "FileExt", 1, null, 54 },
                    { 94, "", 5, true, 1160, "FilePath", 3, null, 54 },
                    { 95, ".sln", 1, true, 1160, "FileExt", 2, null, 54 },
                    { 96, "", 4, true, 1160, "SlnGuid", 1, null, 54 },
                    { 100, "", 4, true, 1200, "FilePath", 11, null, 54 },
                    { 101, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 102, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 103, "1", 2, true, 1200, "IsNullable", 8, null, 55 },
                    { 104, "1", 2, true, 1200, "ImplicitUsing", 7, null, 55 },
                    { 105, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 106, "1.0.0.0", 4, true, 1200, "AssemblyVersion", 5, null, 54 },
                    { 107, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 108, "0", 2, true, 1200, "IsTestLib", 3, null, 55 },
                    { 109, ".csproj", 1, true, 1200, "FileExt", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 69, "", 5, true, 1077, "FilePath", 10, null, 54 },
                    { 70, "", 4, true, 1077, "HasUrl", 8, null, 54 },
                    { 71, "261", 10, true, 1077, "ResolveState", 7, 260, 57 },
                    { 72, "0", 2, true, 1077, "ResolveLink", 5, null, 55 },
                    { 73, "0", 2, true, 1077, "ExtractLink", 3, null, 55 },
                    { 74, "", 12, true, 1077, "GuildNotes", 2, null, 54 },
                    { 75, "20", 3, true, 1077, "MaxLinks", 1, null, 57 },
                    { 84, "104", 10, true, 1121, "Results", 1, 100, 57 },
                    { 87, "104", 10, true, 1131, "Results", 1, 100, 57 },
                    { 90, "104", 10, true, 1141, "Results", 1, 100, 57 },
                    { 93, "104", 10, true, 1151, "Results", 1, 100, 57 },
                    { 97, "104", 10, true, 1161, "Results", 1, 100, 57 },
                    { 98, "", 10, true, 1162, "RegisterObj", 3, 1200, 57 },
                    { 99, "", 4, true, 1162, "ProjectGuid", 2, null, 54 },
                    { 110, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 111, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 112, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 113, "", 4, true, 1210, "PrivateAssets", 4, null, 54 },
                    { 114, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 115, "", 10, true, 1220, "LibInclude", 1, 1200, 57 },
                    { 116, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 117, ".cs", 1, true, 1300, "FileExt", 6, null, 54 },
                    { 118, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 119, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 120, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 130, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 131, "", 4, true, 1400, "Namespace", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 121, "104", 10, true, 1301, "Results", 1, 100, 57 },
                    { 122, "42", 10, true, 1302, "LifetimeScope", 3, 40, 57 },
                    { 123, "", 10, true, 1302, "RegisterObj", 2, 1500, 57 },
                    { 124, "", 2, true, 1302, "RegisterIntf", 1, null, 55 },
                    { 125, "", 4, true, 1310, "FilePath", 3, null, 54 },
                    { 126, ".cs", 4, true, 1310, "FileExt", 2, null, 54 },
                    { 127, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 132, "104", 10, true, 1401, "Results", 1, 100, 57 },
                    { 133, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 },
                    { 134, ".cs", 4, true, 1450, "FileExt", 16, null, 54 },
                    { 135, "", 4, true, 1450, "FilePath", 15, null, 54 },
                    { 136, "", 4, true, 1450, "Namespace", 14, null, 54 },
                    { 137, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 138, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    { 140, "91", 10, true, 1460, "AccessModifier", 17, 90, 57 },
                    { 141, ".cs", 4, true, 1460, "FileExt", 16, null, 54 },
                    { 142, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 143, "", 4, true, 1460, "Namespace", 14, null, 54 },
                    { 144, "", 10, true, 1460, "BaseType", 13, 50, 57 },
                    { 145, "", 2, true, 1460, "GenInterface", 12, null, 55 },
                    { 147, "0", 2, true, 1500, "TestClass", 19, null, 55 },
                    { 148, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 149, ".cs", 1, true, 1500, "FileExt", 17, null, 54 },
                    { 150, "", 4, true, 1500, "FilePath", 16, null, 54 },
                    { 151, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 152, "", 10, true, 1500, "BaseType", 14, 1500, 57 },
                    { 153, "", 2, true, 1500, "GenInterface", 13, null, 55 },
                    { 154, "", 2, true, 1500, "RegisterDI", 12, null, 55 },
                    { 155, "0", 2, true, 1500, "IsStatic", 11, null, 55 },
                    { 180, ".cs", 1, true, 1600, "FileExt", 17, null, 54 },
                    { 181, "", 4, true, 1600, "FilePath", 16, null, 54 },
                    { 182, "", 4, true, 1600, "Namespace", 15, null, 54 },
                    { 183, "dbo", 4, true, 1600, "DbSchema", 14, null, 54 },
                    { 184, "", 4, true, 1600, "DbTableName", 13, null, 54 },
                    { 206, ".cs", 1, true, 1700, "FileExt", 16, null, 54 },
                    { 207, "", 4, true, 1700, "FilePath", 15, null, 54 },
                    { 208, "", 4, true, 1700, "Namespace", 14, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 129, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 139, "104", 10, true, 1451, "Results", 1, 100, 57 },
                    { 146, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 156, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 157, "", 10, true, 1502, "ImportObj", 4, 1500, 57 },
                    { 158, "", 2, true, 1502, "UseIntf", 3, null, 55 },
                    { 159, "57", 10, true, 1510, "PropType", 5, 50, 57 },
                    { 160, "", 10, true, 1510, "PropClass", 4, 1500, 57 },
                    { 161, "1", 2, true, 1510, "IsNullable", 3, null, 55 },
                    { 162, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    { 164, "32", 10, true, 1520, "TestMethod", 19, 31, 57 },
                    { 165, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    { 166, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 167, "", 10, true, 1520, "ReturnClass", 16, 1500, 57 },
                    { 168, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 169, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 170, "0", 2, true, 1520, "IsVirtual", 13, null, 55 },
                    { 171, "0", 2, true, 1520, "IsStatic", 12, null, 55 },
                    { 172, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 173, "0", 2, true, 1520, "IsSealed", 10, null, 55 },
                    { 185, "104", 10, true, 1601, "Results", 1, 100, 57 },
                    { 186, "", 10, true, 1602, "ImportObj", 4, 1500, 57 },
                    { 187, "", 2, true, 1602, "UseIntf", 3, null, 55 },
                    { 188, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 189, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 190, "1", 2, true, 1610, "HasSetter", 6, null, 55 },
                    { 191, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 192, "0", 2, true, 1610, "IsPrimaryKey", 4, null, 55 },
                    { 193, "-1", 3, true, 1610, "MaxSize", 3, null, 57 },
                    { 200, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 201, "", 10, true, 1630, "ForeignKey", 6, 1610, 57 },
                    { 202, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 203, "1", 2, true, 1630, "IsNullable", 4, null, 55 },
                    { 204, "", 4, true, 1630, "InverseNav", 3, null, 54 },
                    { 209, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 210, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 211, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 212, "", 10, true, 1720, "PropClass", 2, 1500, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 163, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 174, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 175, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 176, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 177, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 178, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 194, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 195, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 196, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 197, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 198, "1", 2, true, 1620, "IsNullable", 3, null, 55 },
                    { 205, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 213, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 214, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 215, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 216, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 217, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 218, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 219, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 220, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 221, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 222, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 223, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 224, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 225, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 226, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 227, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 228, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 229, "0", 2, true, 1830, "IsSealed", 10, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 179, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 199, "104", 10, true, 1621, "Results", 1, 100, 57 },
                    { 230, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 231, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 232, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 233, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 234, "0", 2, true, 1840, "UseThis", 2, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 235, "104", 10, true, 1841, "Results", 1, 100, 57 });
