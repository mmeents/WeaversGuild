        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemPropertyDefaultId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 10, "Owner Type of SQL Types", 10, "", true, "SqlTypes", null, 2 },
                    { 18, "sql float type", -1, "", true, "SqlFloatType", 18, 0 },
                    { 31, "Test Method Attributes", 10, "", true, "TestMethodTypes", null, 3 },
                    { 40, "Owner Type of C# Lifetimes", 10, "", true, "CSharpLifetimes", null, 4 },
                    { 50, "Owner Type of C# Types", 10, "", true, "CSharpTypes", null, 5 },
                    { 80, "Entity Delete Behaviors", -1, "", true, "EntityDeleteBehaviors", null, 6 },
                    { 90, "Accessibility Lookups", 10, "", true, "AccessibilityLookups", null, 7 },
                    { 100, "Review State", 10, "", true, "RatingStatus", null, 8 },
                    { 110, "Ratings", 10, "", true, "Ratings", null, 9 },
                    { 115, "Floor Status", 10, "", true, "FloorStatus", null, 10 },
                    { 120, "Loom Mcp Commands", 10, "", true, "LoomMcpCommands", null, 11 },
                    { 220, "Todo Statuses", 10, "", true, "TodoStatuses", null, 12 },
                    { 230, "Run Status", 10, "", true, "RunStatus", null, 13 },
                    { 250, "Desk Pre-Assert Check Types", 10, "", true, "DeskPreAssertCheckTypes", null, 14 },
                    { 260, "Link Resolution Types", -1, "", true, "LinkResolutionTypes", null, 15 },
                    { 270, "Story Status", -1, "", true, "StoryStatus", null, 16 },
                    { 280, "Scene Status", -1, "", true, "SceneStatus", null, 17 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 172246148L, "104", 10, true, 1311, "Results", 1, 100, 57 },
                    { 456313588L, "3", 3, true, 1000, "KeepDays", 1, null, 57 },
                    { 475612168L, "", 12, true, 1000, "Charter", 3, null, 54 },
                    { 968744252L, "112", 10, true, 1107, "Votes", 1, 110, 57 },
                    { 1914257832L, "", 13, true, 1000, "RootFolder", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 301, "Not Started", -1, "", true, "GameNotStarted", 300, 2 },
                    { 302, "In Progress", -1, "", true, "GameInProgress", 300, 3 },
                    { 303, "Completed", -1, "", true, "GameCompleted", 300, 4 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 30480761L, "", 12, true, 1160, "Tone", 11, null, 54 },
                    { 113667808L, "", 13, true, 1100, "RelativeFolder", 2, null, 54 },
                    { 162276746L, "", 12, true, 1040, "Notes", 5, null, 54 },
                    { 311527421L, "", 14, true, 1060, "RelativeFolder", 1, null, 54 },
                    { 581826805L, "", 13, true, 1080, "RelativeFolder", 2, null, 54 },
                    { 902105046L, "", 14, true, 1036, "RelativeFolder", 1, null, 54 },
                    { 1103093209L, "", 12, true, 1160, "CoverImgPrompt", 8, null, 54 },
                    { 1295334515L, "116", 10, true, 1040, "FloorStatus", 9, 115, 57 },
                    { 1580820728L, "", 4, true, 1010, "MachineName", 3, null, 54 },
                    { 1741533087L, "", 14, true, 1040, "RelativeFolder", 7, null, 54 },
                    { 1780352498L, "", 14, true, 1030, "RelativeFolder", 1, null, 54 },
                    { 1970449728L, "", 14, true, 1070, "RelativeFolder", 10, null, 54 },
                    { 2073463200L, "", 12, true, 1070, "GuildNotes", 2, null, 54 },
                    { 2140676322L, "", 15, true, 1160, "CoverImgUrl", 5, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 57196853L, "", 5, true, 1045, "FilePath", 1, null, 54 },
                    { 83745119L, "", 18, true, 1038, "RoleCmds", 8, 120, 54 },
                    { 95478020L, "", 6, true, 1026, "Expires", 8, null, 65 },
                    { 126477941L, "", 10, true, 1045, "OnSuccessTo", 7, 1045, 57 },
                    { 143860739L, "0", 2, true, 1013, "HasClaudeCode", 2, null, 55 },
                    { 171654446L, "", 10, true, 1045, "OnFailTo", 6, 1045, 57 },
                    { 174336495L, "", 4, true, 1085, "GameResult", 17, null, 54 },
                    { 248253779L, "", 12, true, 1180, "Realm", 10, null, 54 },
                    { 285663836L, "", 9, true, 1026, "GithubPAT", 9, null, 54 },
                    { 335348255L, "", 10, true, 1043, "Operator", 5, 1035, 57 },
                    { 341627559L, "", 4, true, 1180, "AddedBy", 5, null, 54 },
                    { 347957999L, "271", 10, true, 1163, "StoryStatus", 9, 270, 57 },
                    { 370020922L, "", 10, true, 1045, "OnPushbackTo", 5, 1045, 57 },
                    { 427067567L, "", 18, true, 1038, "PreAsserts", 7, 250, 54 },
                    { 462727412L, "291", 10, true, 1163, "PovDefault", 8, 290, 57 }
                });

            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsReadOnly", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 534467406L, "301", 10, true, true, 1085, "GameStatus", 18, 300, 57 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 690951521L, "", 12, true, 1035, "SysPrompt", 7, null, 54 },
                    { 707823266L, "", 12, true, 1180, "CoverImgPrompt", 3, null, 54 },
                    { 752156328L, "104", 10, true, 1101, "Results", 1, 100, 57 },
                    { 804693866L, "", 17, true, 1045, "SysPrompt", 9, null, 54 },
                    { 841006774L, "", 12, true, 1026, "GuildNotes", 7, null, 54 },
                    { 938685641L, "1", 2, true, 1043, "Enabled", 11, null, 55 },
                    { 941576447L, "", 15, true, 1180, "CoverImgUrl", 2, null, 54 },
                    ...
                    { 1596160928L, "", 14, true, 1110, "RelativeFolder", 1, null, 54 },
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsReadOnly", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 2051265710L, "306", 10, true, true, 1085, "SideToMove", 15, 305, 57 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 503036444L, ".md", 4, true, 1120, "FileExt", 1, null, 54 },
                    ...
                    { 994523474L, "", 4, true, 1190, "SlnGuid", 1, null, 54 },
                    { 1068052878L, "", 5, true, 1076, "FilePath", 10, null, 54 },
                    { 1070389630L, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 1114029626L, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 1142573919L, "", 4, true, 1012, "MachineName", 3, null, 54 },
                    { 1168424395L, "", 5, true, 1190, "FilePath", 3, null, 54 },
                    { 1244784032L, "", 4, true, 1016, "UrlBase", 3, null, 54 },
                    { 1331523966L, "", 12, true, 1166, "ExitState", 8, null, 54 },
                    { 1338310880L, "", 5, true, 1130, "FilePath", 2, null, 54 },
                    { 1375736661L, "0", 2, true, 1076, "ResolveLink", 5, null, 55 },
                    { 1436764987L, "", 4, true, 1166, "AddedBy", 3, null, 54 },
                    { 1464048859L, "0", 2, true, 1166, "BeatsRequested", 5, null, 55 },
                    ...
                    { 1985780519L, "", 4, true, 1012, "UserName", 4, null, 54 },
                    { 2012138855L, "", 12, true, 1050, "CloseReason", 7, null, 54 },
                    { 2025675266L, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 2034260755L, "", 4, true, 1115, "EntrySha", 15, null, 54 },
                    { 2075791736L, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 2117176729L, ".sln", 1, true, 1190, "FileExt", 2, null, 54 },
                    { 2122690042L, "221", 10, true, 1050, "Status", 11, 220, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7199943L, "", 5, true, 1116, "GitPath", 20, null, 54 },
                    { 35978632L, "0", 3, true, 1116, "FileSize", 13, null, 58 },
                    { 56783169L, "", 4, true, 1017, "ModelName", 9, null, 54 },
                    { 99943886L, "20", 3, true, 1077, "MaxLinks", 1, null, 57 },
                    { 109377412L, "", 6, true, 1116, "ParsedOn", 7, null, 64 },
                    { 158444440L, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 193637418L, "", 4, true, 1114, "LastCommitAuthor", 12, null, 54 },
                    { 330268806L, "104", 10, true, 1121, "Results", 1, 100, 57 },
                    { 338646945L, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 347887796L, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 459039432L, "100000", 3, true, 1017, "ContextLength", 8, null, 57 },
                    { 461558051L, "", 4, true, 1114, "TrackedBranch", 16, null, 54 },
                    { 503848702L, "", 4, true, 1017, "ModelKey", 10, null, 54 },
                    { 583170659L, "", 4, true, 1019, "ModelKey", 1, null, 54 },
                    ...
                    { 933486359L, "", 4, true, 1114, "BranchName", 20, null, 54 },
                    { 958367472L, "", 12, true, 1114, "LastCommitMsg", 13, null, 54 },
                    { 1074966866L, "231", 10, true, 1055, "Status", 10, 230, 57 },
                    { 1096875778L, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 1148540228L, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 1167220483L, "0", 10, true, 1112, "CurrentBranch", 16, 1114, 57 },
                    { 1180727337L, "", 4, true, 1077, "MediaType", 5, null, 54 },
                    { 1211184279L, "104", 10, true, 1141, "Results", 1, 100, 57 },
                    { 1224608613L, "261", 10, true, 1077, "ResolveState", 7, 260, 57 },
                    { 1272438009L, "", 4, true, 1400, "Namespace", 2, null, 54 },
                    { 1284098294L, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 1314713596L, "", 12, true, 1077, "GuildNotes", 2, null, 54 },
                    { 1361870553L, "0", 10, true, 1116, "RepoItemId", 9, 1112, 57 },
                    { 1376306593L, "", 4, true, 1114, "LastCommitSha", 15, null, 54 },
                    { 1387498301L, "", 4, true, 1114, "FriendlyName", 19, null, 54 },
                    { 1405211824L, "0", 2, true, 1114, "IsRemote", 17, null, 55 },
                    { 1420024403L, "", 4, true, 1077, "HasUrl", 8, null, 54 },
                    { 1435757137L, "", 4, true, 1192, "ProjectGuid", 2, null, 54 },
                    { 1448435365L, "104", 10, true, 1191, "Results", 1, 100, 57 },
                    { 1451031518L, "1", 2, true, 1019, "SkipPerms", 2, null, 55 },
                    { 1510965817L, "0", 2, true, 1116, "IsBinary", 11, null, 55 },
                    { 1517958793L, "", 5, true, 1116, "FilePath", 20, null, 54 },
                    { 1544731406L, "104", 10, true, 1131, "Results", 1, 100, 57 },
                    { 1644398767L, "", 5, true, 1077, "FilePath", 10, null, 54 },
                    { 1686169926L, "", 12, true, 1055, "Response", 6, null, 54 },
                    { 1724844843L, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 1740548193L, "", 12, true, 1017, "ModelDetails", 7, null, 54 },
                    { 1789760111L, "", 4, true, 1116, "FileExt", 18, null, 54 },
                    { 1824259462L, "", 4, true, 1116, "EntrySha", 15, null, 54 },
                    { 1830094045L, "", 10, true, 1035, "Presence", 8, 1017, 57 },
                    { 1836476276L, "0", 2, true, 1170, "CallSheetRequested", 10, null, 55 },
                    { 1948823302L, "", 6, true, 1114, "LastCommitDate", 14, null, 64 },
                    { 1963959515L, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 1975724659L, "", 10, true, 1055, "NextTodo", 9, 1050, 57 },
                    { 1984583250L, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 1985844536L, "", 10, true, 1192, "RegisterObj", 3, 1200, 57 },
                    { 2035998976L, "", 10, true, 1220, "LibInclude", 1, 1200, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 23709495L, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 26988987L, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 34298977L, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 108233110L, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 120358259L, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 165676863L, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    ...
                    { 2139986171L, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 399473623L, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 407009139L, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 410850321L, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 484247079L, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 686604843L, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 732466838L, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    ...
                    { 1053020775L, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 1094585571L, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 1222748968L, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    ...
                    { 1477401246L, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 1505953480L, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 1511194975L, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 1557931015L, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 1600590984L, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 1614104559L, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 1627149234L, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 1733380882L, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 1895756653L, "", 2, true, 1502, "UseIntf", 3, null, 55 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 100683383L, "0", 2, true, 1830, "IsSealed", 10, null, 55 },
                    { 165039933L, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 198342137L, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 214649818L, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 271041643L, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 326085807L, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 400374646L, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 435110243L, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 511388978L, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 695607933L, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 732773512L, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 751923744L, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 754093581L, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 761338008L, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 916995028L, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 945890910L, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 973950680L, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 1094950923L, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 1335396840L, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 1353199663L, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 1542050435L, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 1548243206L, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 1650518752L, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 1682256405L, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 1855744350L, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 1857665773L, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 1991658610L, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 2072517106L, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 2113595600L, "1", 2, true, 1620, "IsNullable", 3, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 289792653L, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 409176547L, "0", 2, true, 1840, "UseThis", 2, null, 55 },
                    { 420647376L, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 1008655715L, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 1423533073L, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 1536394150L, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 1887887978L, "104", 10, true, 1621, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 239919327L, "104", 10, true, 1841, "Results", 1, 100, 57 });
