...
{
    /// <inheritdoc />
    public partial class InitialDb152 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 1160, "Realm", -1, "", true, "RealmModel", 1160, 1160 },
                    { 1163, "Story", -1, "", true, "StoryModel", 1163, 1163 },
                    { 1166, "Scene", -1, "", true, "SceneModel", 1166, 1166 },
                    { 1168, "Character", -1, "", true, "CharacterModel", 1168, 1168 },
                    { 1170, "Beat", -1, "", true, "BeatModel", 1170, 1170 },
                    { 1172, "Call Sheet", -1, "", true, "CallSheetModel", 1172, 1172 },
                    { 1177, "Performance", -1, "", true, "PerformanceModel", 1177, 1177 },
                    { 1178, "Actor Performance", -1, "", true, "ActorPerformanceModel", 1178, 1178 },
                    { 1179, "Observed", -1, "", true, "ObservationModel", 1179, 1179 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 127, "", 4, true, 1160, "Tone", 1, null, 54 },
                    { 128, "5", 3, true, 1163, "TargetSceneCount", 10, null, 57 },
                    { 129, "271", 10, true, 1163, "StoryStatus", 9, 270, 57 },
                    { 130, "291", 10, true, 1163, "PovDefault", 8, 290, 57 },
                    { 131, "281", 10, true, 1166, "SceneStatus", 10, 280, 57 },
                    { 132, "", 4, true, 1166, "EntryState", 9, null, 54 },
                    { 133, "", 4, true, 1166, "ExitState", 8, null, 54 },
                    { 134, "291", 10, true, 1166, "POV", 7, 290, 57 },
                    { 135, "0", 2, true, 1166, "BeatsRequested", 5, null, 55 },
                    { 136, "0", 2, true, 1170, "CallSheetRequested", 10, null, 55 },
                    { 137, "0", 10, true, 1178, "Character", 15, 1168, 57 },
                    { 138, "0", 10, true, 1178, "FromCallSheet", 13, 1172, 57 },
                    { 139, "", 12, true, 1178, "Instructions", 10, null, 54 },
                    { 140, "", 3, true, 1178, "LineNumber", 8, null, 57 },
                    { 175, "104", 10, true, 1311, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 180, "addSolution", 4, "", true, "CmdAddSolution", 120, 52 },
                    { 181, "addSolutionImport", 4, "", true, "CmdAddSolutionImport", 120, 53 },
                    { 182, "addMdFile", 4, "", true, "CmdAddMdFile", 120, 54 },
                    { 183, "addHtmlFile", 4, "", true, "CmdAddHtmlFile", 120, 55 },
                    { 184, "addConfigFile", 4, "", true, "CmdAddConfigFile", 120, 56 },
                    { 185, "addLibrary", 4, "", true, "CmdAddLibrary", 120, 57 },
                    { 186, "addNamespace", 4, "", true, "CmdAddNamespace", 120, 58 },
                    { 187, "addClass", 4, "", true, "CmdAddClass", 120, 59 },
                    { 188, "addClassImport", 4, "", true, "CmdAddClassImport", 120, 60 },
                    { 189, "addClassProperty", 4, "", true, "CmdAddClassProperty", 120, 61 },
                    { 190, "addClassMethod", 4, "", true, "CmdAddClassMethod", 120, 62 },
                    { 191, "addClassMethodParam", 4, "", true, "CmdAddClassMethodParam", 120, 63 },
                    { 192, "addEntityClass", 4, "", true, "CmdAddEntityClass", 120, 64 },
                    { 194, "addEntityProperty", 4, "", true, "CmdAddEntityProperty", 120, 66 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 141, "", 5, true, 1190, "FilePath", 3, null, 54 },
                    { 142, ".sln", 1, true, 1190, "FileExt", 2, null, 54 },
                    { 143, "", 4, true, 1190, "SlnGuid", 1, null, 54 },
                    { 147, "", 4, true, 1200, "FilePath", 11, null, 54 },
                    { 148, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 149, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 150, "1", 2, true, 1200, "IsNullable", 8, null, 55 },
                    { 151, "1", 2, true, 1200, "ImplicitUsing", 7, null, 55 },
                    { 152, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 153, "1.0.0.0", 4, true, 1200, "AssemblyVersion", 5, null, 54 },
                    { 154, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 155, "0", 2, true, 1200, "IsTestLib", 3, null, 55 },
                    { 156, ".csproj", 1, true, 1200, "FileExt", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 144, "104", 10, true, 1191, "Results", 1, 100, 57 },
                    { 145, "", 10, true, 1192, "RegisterObj", 3, 1200, 57 },
                    { 146, "", 4, true, 1192, "ProjectGuid", 2, null, 54 },
                    { 157, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 158, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 159, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 160, "", 4, true, 1210, "PrivateAssets", 4, null, 54 },
                    { 161, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 162, "", 10, true, 1220, "LibInclude", 1, 1200, 57 },
                    { 163, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 164, ".cs", 1, true, 1300, "FileExt", 6, null, 54 },
                    { 165, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 166, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 167, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 177, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 178, "", 4, true, 1400, "Namespace", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 168, "104", 10, true, 1301, "Results", 1, 100, 57 },
                    { 169, "42", 10, true, 1302, "LifetimeScope", 3, 40, 57 },
                    { 170, "", 10, true, 1302, "RegisterObj", 2, 1500, 57 },
                    { 171, "", 2, true, 1302, "RegisterIntf", 1, null, 55 },
                    { 172, "", 4, true, 1310, "FilePath", 3, null, 54 },
                    { 173, ".cs", 4, true, 1310, "FileExt", 2, null, 54 },
                    { 174, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 179, "104", 10, true, 1401, "Results", 1, 100, 57 },
                    { 180, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 },
                    { 181, ".cs", 4, true, 1450, "FileExt", 16, null, 54 },
                    { 182, "", 4, true, 1450, "FilePath", 15, null, 54 },
                    { 183, "", 4, true, 1450, "Namespace", 14, null, 54 },
                    { 184, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 185, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    { 187, "91", 10, true, 1460, "AccessModifier", 17, 90, 57 },
                    { 188, ".cs", 4, true, 1460, "FileExt", 16, null, 54 },
                    { 189, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 190, "", 4, true, 1460, "Namespace", 14, null, 54 },
                    { 191, "", 10, true, 1460, "BaseType", 13, 50, 57 },
                    { 192, "", 2, true, 1460, "GenInterface", 12, null, 55 },
                    { 194, "0", 2, true, 1500, "TestClass", 19, null, 55 },
                    { 195, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 196, ".cs", 1, true, 1500, "FileExt", 17, null, 54 },
                    { 197, "", 4, true, 1500, "FilePath", 16, null, 54 },
                    { 198, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 199, "", 10, true, 1500, "BaseType", 14, 1500, 57 },
                    { 200, "", 2, true, 1500, "GenInterface", 13, null, 55 },
                    { 201, "", 2, true, 1500, "RegisterDI", 12, null, 55 },
                    { 202, "0", 2, true, 1500, "IsStatic", 11, null, 55 },
                    { 227, ".cs", 1, true, 1600, "FileExt", 17, null, 54 },
                    { 228, "", 4, true, 1600, "FilePath", 16, null, 54 },
                    { 229, "", 4, true, 1600, "Namespace", 15, null, 54 },
                    { 230, "dbo", 4, true, 1600, "DbSchema", 14, null, 54 },
                    { 231, "", 4, true, 1600, "DbTableName", 13, null, 54 },
                    { 253, ".cs", 1, true, 1700, "FileExt", 16, null, 54 },
                    { 254, "", 4, true, 1700, "FilePath", 15, null, 54 },
                    { 255, "", 4, true, 1700, "Namespace", 14, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 176, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 186, "104", 10, true, 1451, "Results", 1, 100, 57 },
                    { 193, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 203, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 204, "", 10, true, 1502, "ImportObj", 4, 1500, 57 },
                    { 205, "", 2, true, 1502, "UseIntf", 3, null, 55 },
                    { 206, "57", 10, true, 1510, "PropType", 5, 50, 57 },
                    { 207, "", 10, true, 1510, "PropClass", 4, 1500, 57 },
                    { 208, "1", 2, true, 1510, "IsNullable", 3, null, 55 },
                    { 209, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    { 211, "32", 10, true, 1520, "TestMethod", 19, 31, 57 },
                    { 212, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    { 213, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 214, "", 10, true, 1520, "ReturnClass", 16, 1500, 57 },
                    { 215, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 216, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 217, "0", 2, true, 1520, "IsVirtual", 13, null, 55 },
                    { 218, "0", 2, true, 1520, "IsStatic", 12, null, 55 },
                    { 219, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 220, "0", 2, true, 1520, "IsSealed", 10, null, 55 },
                    { 232, "104", 10, true, 1601, "Results", 1, 100, 57 },
                    { 233, "", 10, true, 1602, "ImportObj", 4, 1500, 57 },
                    { 234, "", 2, true, 1602, "UseIntf", 3, null, 55 },
                    { 235, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 236, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 237, "1", 2, true, 1610, "HasSetter", 6, null, 55 },
                    { 238, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 239, "0", 2, true, 1610, "IsPrimaryKey", 4, null, 55 },
                    { 240, "-1", 3, true, 1610, "MaxSize", 3, null, 57 },
                    { 247, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 248, "", 10, true, 1630, "ForeignKey", 6, 1610, 57 },
                    { 249, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 250, "1", 2, true, 1630, "IsNullable", 4, null, 55 },
                    { 251, "", 4, true, 1630, "InverseNav", 3, null, 54 },
                    { 256, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 257, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 258, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 259, "", 10, true, 1720, "PropClass", 2, 1500, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 210, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 221, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 222, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 223, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 224, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 225, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 241, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 242, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 243, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 244, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 245, "1", 2, true, 1620, "IsNullable", 3, null, 55 },
                    { 252, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 260, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 261, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 262, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 263, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 264, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 265, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 266, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 267, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 268, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 269, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 270, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 271, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 272, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 273, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 274, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 275, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 276, "0", 2, true, 1830, "IsSealed", 10, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 226, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 246, "104", 10, true, 1621, "Results", 1, 100, 57 },
                    { 277, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 278, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 279, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 280, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 281, "0", 2, true, 1840, "UseThis", 2, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 282, "104", 10, true, 1841, "Results", 1, 100, 57 });
