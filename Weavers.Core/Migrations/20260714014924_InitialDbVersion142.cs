...
{
    /// <inheritdoc />
    public partial class InitialDbVersion142 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 73, "112", 10, true, 1107, "Votes", 1, 110, 57 },
                    { 122, "104", 10, true, 1311, "Results", 1, 100, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 138, "Complete Todo Command", -1, "", true, "CmdCompleteTodo", 120, 10 },
                    { 139, "Reject Todo Command", -1, "", true, "CmdRejectTodo", 120, 11 },
                    { 140, "Review Pass Command", -1, "", true, "CmdReviewPass", 120, 12 },
                    { 141, "Review Fail Command", -1, "", true, "CmdReviewFail", 120, 13 },
                    { 142, "Add Org Desk Role Command", 4, "", true, "CmdAddOrgDeskRole", 120, 14 },
                    { 143, "Add Org Desk Command", -1, "", true, "CmdAddOrgDesk", 120, 15 },
                    { 144, "Add Desk Todo Command", -1, "", true, "CmdAddDeskTodo", 120, 16 },
                    { 145, "Add Digital Operator Command", -1, "", true, "CmdAddDigitalOperatior", 120, 17 },
                    { 146, "Add Org Folder Command", -1, "", true, "CmdAddOrgFolder", 120, 18 },
                    { 148, "Add Org File Command", -1, "", true, "CmdAddOrgFile", 120, 19 },
                    { 149, "Add Rss Folder Command", 4, "", true, "CmdAddRssFolder", 120, 20 },
                    { 150, "Add Rss Channel Command", 4, "", true, "CmdAddRssChannel", 120, 21 },
                    { 151, "Resync Rss Channel Command", 4, "", true, "CmdRssResyncChannel", 120, 22 },
                    { 152, "Resolve Rss Link Command", 4, "", true, "CmdRssResolveLink", 120, 23 },
                    { 153, "Extract Rss Links Command", 4, "", true, "CmdRssExtractLinks", 120, 24 },
                    { 154, "Add Project Root Command", 4, "", true, "CmdAddProjectRoot", 120, 23 },
                    { 155, "Add Sub Folder Command", 4, "", true, "CmdAddSubFolder", 120, 24 },
                    { 156, "Add Solution Command", 4, "", true, "CmdAddSolution", 120, 25 },
                    { 157, "Add Solution Import Command", 4, "", true, "CmdAddSolutionImport", 120, 26 },
                    { 158, "Add Md File Command", 4, "", true, "CmdAddMdFile", 120, 27 },
                    { 160, "Add Html File Command", 4, "", true, "CmdAddHtmlFile", 120, 28 },
                    { 162, "Add Config File Command", 4, "", true, "CmdAddConfigFile", 120, 29 },
                    { 164, "Add Library Command", 4, "", true, "CmdAddLibrary", 120, 30 },
                    { 166, "Add Namespace Command", 4, "", true, "CmdAddNamespace", 120, 31 },
                    { 168, "Add Class Command", 4, "", true, "CmdAddClass", 120, 32 },
                    { 170, "Add Class Import Command", 4, "", true, "CmdAddClassImport", 120, 33 },
                    { 172, "Add Class Property Command", 4, "", true, "CmdAddClassProperty", 120, 34 },
                    { 174, "Add Class Method Command", 4, "", true, "CmdAddClassMethod", 120, 35 },
                    { 176, "Add Class Method Param Command", 4, "", true, "CmdAddClassMethodParam", 120, 36 },
                    { 178, "Add Entity Class Command", 4, "", true, "CmdAddEntityClass", 120, 37 },
                    { 180, "Add Entity Class Import Command", 4, "", true, "CmdAddEntityClassImport", 120, 38 },
                    { 182, "Add Entity Property Command", 4, "", true, "CmdAddEntityProperty", 120, 39 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 56, "", 14, true, 1070, "RelativeFolder", 10, null, 54 },
                    { 70, "", 13, true, 1100, "RelativeFolder", 2, null, 54 },
                    { 71, "", 4, true, 1100, "RepoUrl", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 35, "", 10, true, 1045, "OnSuccessTo", 7, 1045, 57 },
                    { 36, "", 10, true, 1045, "OnFailTo", 6, 1045, 57 },
                    { 37, "", 10, true, 1045, "OnPushbackTo", 5, 1045, 57 },
                    { 38, "3", 3, true, 1045, "MaxAttempts", 4, null, 57 },
                    { 40, "", 5, true, 1045, "FilePath", 1, null, 54 },
                    { 55, "", 5, true, 1065, "FilePath", 1, null, 54 },
                    { 57, "", 14, true, 1075, "RelativeFolder", 10, null, 54 },
                    { 58, "", 4, true, 1075, "ChannelUrl", 5, null, 54 },
                    { 59, "0", 2, true, 1075, "DoResync", 3, null, 55 },
                    { 72, "104", 10, true, 1101, "Results", 1, 100, 57 },
                    { 74, "", 14, true, 1110, "RelativeFolder", 1, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 43, "", 16, true, 1050, "RefItem", 10, null, 57 },
                    { 44, "", 17, true, 1050, "UserPrompt", 9, null, 54 },
                    { 45, "", 10, true, 1050, "FromTodo", 8, 1050, 57 },
                    { 46, "", 12, true, 1050, "CloseReason", 7, null, 54 },
                    { 47, "1", 3, true, 1050, "TodoDepth", 6, null, 57 },
                    { 60, "", 5, true, 1076, "FilePath", 10, null, 54 },
                    { 61, "", 4, true, 1076, "HasUrl", 3, null, 54 },
                    { 62, "0", 2, true, 1076, "ResolveLink", 5, null, 55 },
                    { 63, "0", 2, true, 1076, "ExtractLink", 3, null, 55 },
                    { 64, "20", 3, true, 1076, "MaxLinks", 1, null, 57 },
                    { 75, "104", 10, true, 1111, "Results", 1, 100, 57 },
                    { 76, "", 5, true, 1120, "FilePath", 2, null, 54 },
                    { 77, ".md", 4, true, 1120, "FileExt", 1, null, 54 },
                    { 79, "", 5, true, 1130, "FilePath", 2, null, 54 },
                    { 80, ".html", 4, true, 1130, "FileExt", 1, null, 54 },
                    { 82, "", 5, true, 1140, "FilePath", 2, null, 54 },
                    { 83, ".json", 4, true, 1140, "FileExt", 1, null, 54 },
                    { 85, "", 5, true, 1150, "FilePath", 2, null, 54 },
                    { 86, ".png", 4, true, 1150, "FileExt", 1, null, 54 },
                    { 88, "", 5, true, 1160, "FilePath", 3, null, 54 },
                    { 89, ".sln", 1, true, 1160, "FileExt", 2, null, 54 },
                    { 90, "", 4, true, 1160, "SlnGuid", 1, null, 54 },
                    { 94, "", 4, true, 1200, "FilePath", 11, null, 54 },
                    { 95, "", 4, true, 1200, "NamespaceRoot", 10, null, 54 },
                    { 96, "net9.0", 4, true, 1200, "TargetFramework", 9, null, 54 },
                    { 97, "1", 2, true, 1200, "IsNullable", 8, null, 55 },
                    { 98, "1", 2, true, 1200, "ImplicitUsing", 7, null, 55 },
                    { 99, "1.0.0", 4, true, 1200, "Version", 6, null, 54 },
                    { 100, "1.0.0.0", 4, true, 1200, "AssemblyVersion", 5, null, 54 },
                    { 101, "1.0.0.0", 4, true, 1200, "FileVersion", 4, null, 54 },
                    { 102, "0", 2, true, 1200, "IsTestLib", 3, null, 55 },
                    { 103, ".csproj", 1, true, 1200, "FileExt", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 51, "", 12, true, 1055, "UserPrompt", 7, null, 54 },
                    { 52, "", 12, true, 1055, "Response", 6, null, 54 },
                    { 53, "", 10, true, 1055, "Operator", 5, 1035, 57 },
                    { 65, "", 5, true, 1077, "FilePath", 10, null, 54 },
                    { 66, "", 4, true, 1077, "HasUrl", 8, null, 54 },
                    { 67, "0", 2, true, 1077, "ResolveLink", 5, null, 55 },
                    { 68, "0", 2, true, 1077, "ExtractLink", 3, null, 55 },
                    { 69, "20", 3, true, 1077, "MaxLinks", 1, null, 57 },
                    { 78, "104", 10, true, 1121, "Results", 1, 100, 57 },
                    { 81, "104", 10, true, 1131, "Results", 1, 100, 57 },
                    { 84, "104", 10, true, 1141, "Results", 1, 100, 57 },
                    { 87, "104", 10, true, 1151, "Results", 1, 100, 57 },
                    { 91, "104", 10, true, 1161, "Results", 1, 100, 57 },
                    { 92, "", 10, true, 1162, "RegisterObj", 3, 1200, 57 },
                    { 93, "", 4, true, 1162, "ProjectGuid", 2, null, 54 },
                    { 104, "104", 10, true, 1201, "Results", 1, 100, 57 },
                    { 105, "", 4, true, 1210, "PackageInclude", 6, null, 54 },
                    { 106, "", 4, true, 1210, "PackageVersion", 5, null, 54 },
                    { 107, "", 4, true, 1210, "PrivateAssets", 4, null, 54 },
                    { 108, "", 4, true, 1210, "IncludeAssets", 3, null, 54 },
                    { 109, "", 10, true, 1220, "LibInclude", 1, 1200, 57 },
                    { 110, "", 4, true, 1300, "FilePath", 7, null, 54 },
                    { 111, ".cs", 1, true, 1300, "FileExt", 6, null, 54 },
                    { 112, "", 4, true, 1300, "Namespace", 5, null, 54 },
                    { 113, "", 2, true, 1300, "HasDbContext", 4, null, 55 },
                    { 114, "", 2, true, 1300, "HasMediator", 3, null, 55 },
                    { 124, "", 14, true, 1400, "FilePath", 3, null, 54 },
                    { 125, "", 4, true, 1400, "Namespace", 2, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 115, "104", 10, true, 1301, "Results", 1, 100, 57 },
                    { 116, "42", 10, true, 1302, "LifetimeScope", 3, 40, 57 },
                    { 117, "", 10, true, 1302, "RegisterObj", 2, 1500, 57 },
                    { 118, "", 2, true, 1302, "RegisterIntf", 1, null, 55 },
                    { 119, "", 4, true, 1310, "FilePath", 3, null, 54 },
                    { 120, ".cs", 4, true, 1310, "FileExt", 2, null, 54 },
                    { 121, "", 4, true, 1310, "Namespace", 1, null, 54 },
                    { 126, "104", 10, true, 1401, "Results", 1, 100, 57 },
                    { 127, "91", 10, true, 1450, "AccessModifier", 17, 90, 57 },
                    { 128, ".cs", 4, true, 1450, "FileExt", 16, null, 54 },
                    { 129, "", 4, true, 1450, "FilePath", 15, null, 54 },
                    { 130, "", 4, true, 1450, "Namespace", 14, null, 54 },
                    { 131, "", 10, true, 1450, "BaseType", 13, 50, 57 },
                    { 132, "", 10, true, 1450, "Interface", 12, 1500, 57 },
                    { 134, "91", 10, true, 1460, "AccessModifier", 17, 90, 57 },
                    { 135, ".cs", 4, true, 1460, "FileExt", 16, null, 54 },
                    { 136, "", 4, true, 1460, "FilePath", 15, null, 54 },
                    { 137, "", 4, true, 1460, "Namespace", 14, null, 54 },
                    { 138, "", 10, true, 1460, "BaseType", 13, 50, 57 },
                    { 139, "", 2, true, 1460, "GenInterface", 12, null, 55 },
                    { 141, "0", 2, true, 1500, "TestClass", 19, null, 55 },
                    { 142, "91", 10, true, 1500, "AccessModifier", 18, 90, 57 },
                    { 143, ".cs", 1, true, 1500, "FileExt", 17, null, 54 },
                    { 144, "", 4, true, 1500, "FilePath", 16, null, 54 },
                    { 145, "", 4, true, 1500, "Namespace", 15, null, 54 },
                    { 146, "", 10, true, 1500, "BaseType", 14, 1500, 57 },
                    { 147, "", 2, true, 1500, "GenInterface", 13, null, 55 },
                    { 148, "", 2, true, 1500, "RegisterDI", 12, null, 55 },
                    { 149, "0", 2, true, 1500, "IsStatic", 11, null, 55 },
                    { 174, ".cs", 1, true, 1600, "FileExt", 17, null, 54 },
                    { 175, "", 4, true, 1600, "FilePath", 16, null, 54 },
                    { 176, "", 4, true, 1600, "Namespace", 15, null, 54 },
                    { 177, "dbo", 4, true, 1600, "DbSchema", 14, null, 54 },
                    { 178, "", 4, true, 1600, "DbTableName", 13, null, 54 },
                    { 200, ".cs", 1, true, 1700, "FileExt", 16, null, 54 },
                    { 201, "", 4, true, 1700, "FilePath", 15, null, 54 },
                    { 202, "", 4, true, 1700, "Namespace", 14, null, 54 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 123, "", 10, true, 1312, "RegisterObj", 2, 1600, 57 },
                    { 133, "104", 10, true, 1451, "Results", 1, 100, 57 },
                    { 140, "104", 10, true, 1461, "Results", 1, 100, 57 },
                    { 150, "104", 10, true, 1501, "Results", 1, 100, 57 },
                    { 151, "", 10, true, 1502, "ImportObj", 4, 1500, 57 },
                    { 152, "", 2, true, 1502, "UseIntf", 3, null, 55 },
                    { 153, "57", 10, true, 1510, "PropType", 5, 50, 57 },
                    { 154, "", 10, true, 1510, "PropClass", 4, 1500, 57 },
                    { 155, "1", 2, true, 1510, "IsNullable", 3, null, 55 },
                    { 156, "1", 2, true, 1510, "HasSetter", 2, null, 55 },
                    { 158, "32", 10, true, 1520, "TestMethod", 19, 31, 57 },
                    { 159, "91", 10, true, 1520, "AccessModifier", 18, 90, 57 },
                    { 160, "57", 10, true, 1520, "ReturnType", 17, 50, 57 },
                    { 161, "", 10, true, 1520, "ReturnClass", 16, 1500, 57 },
                    { 162, "0", 2, true, 1520, "ReturnNullable", 15, null, 55 },
                    { 163, "0", 2, true, 1520, "IsAsync", 14, null, 55 },
                    { 164, "0", 2, true, 1520, "IsVirtual", 13, null, 55 },
                    { 165, "0", 2, true, 1520, "IsStatic", 12, null, 55 },
                    { 166, "0", 2, true, 1520, "IsAbstract", 11, null, 55 },
                    { 167, "0", 2, true, 1520, "IsSealed", 10, null, 55 },
                    { 179, "104", 10, true, 1601, "Results", 1, 100, 57 },
                    { 180, "", 10, true, 1602, "ImportObj", 4, 1500, 57 },
                    { 181, "", 2, true, 1602, "UseIntf", 3, null, 55 },
                    { 182, "57", 10, true, 1610, "PropType", 8, 50, 57 },
                    { 183, "0", 2, true, 1610, "IsNullable", 7, null, 55 },
                    { 184, "1", 2, true, 1610, "HasSetter", 6, null, 55 },
                    { 185, "0", 2, true, 1610, "HasNav", 5, null, 55 },
                    { 186, "0", 2, true, 1610, "IsPrimaryKey", 4, null, 55 },
                    { 187, "-1", 3, true, 1610, "MaxSize", 3, null, 57 },
                    { 194, "", 10, true, 1630, "PropClass", 7, 1600, 57 },
                    { 195, "", 10, true, 1630, "ForeignKey", 6, 1610, 57 },
                    { 196, "8", 10, true, 1630, "HasNav", 5, 5, 57 },
                    { 197, "1", 2, true, 1630, "IsNullable", 4, null, 55 },
                    { 198, "", 4, true, 1630, "InverseNav", 3, null, 54 },
                    { 203, "57", 10, true, 1710, "PropType", 3, 50, 57 },
                    { 204, "", 10, true, 1710, "PropClass", 2, 1500, 57 },
                    { 205, "57", 10, true, 1720, "PropType", 3, 50, 57 },
                    { 206, "", 10, true, 1720, "PropClass", 2, 1500, 57 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 157, "104", 10, true, 1511, "Results", 1, 100, 57 },
                    { 168, "104", 10, true, 1521, "Results", 1, 100, 57 },
                    { 169, "57", 10, true, 1530, "ParamType", 5, 50, 57 },
                    { 170, "", 10, true, 1530, "ParamClass", 4, 1500, 57 },
                    { 171, "1", 2, true, 1530, "IsNullable", 3, null, 55 },
                    { 172, "0", 2, true, 1530, "UseThis", 2, null, 55 },
                    { 188, "104", 10, true, 1611, "Results", 1, 100, 57 },
                    { 189, "", 10, true, 1620, "PropClass", 6, 1600, 57 },
                    { 190, "7", 10, true, 1620, "HasNav", 5, 5, 57 },
                    { 191, "84", 10, true, 1620, "DeleteBehavior", 4, 80, 57 },
                    { 192, "1", 2, true, 1620, "IsNullable", 3, null, 55 },
                    { 199, "104", 10, true, 1631, "Results", 1, 100, 57 },
                    { 207, "104", 10, true, 1801, "Results", 1, 100, 57 },
                    { 208, "", 10, true, 1802, "ImportObj", 4, 1500, 57 },
                    { 209, "", 2, true, 1802, "UseIntf", 3, null, 55 },
                    { 210, "57", 10, true, 1811, "PropType", 5, 50, 57 },
                    { 211, "", 10, true, 1811, "PropClass", 4, 1500, 57 },
                    { 212, "1", 2, true, 1811, "IsNullable", 3, null, 55 },
                    { 213, "1", 2, true, 1811, "HasSetter", 2, null, 55 },
                    { 214, "32", 10, true, 1830, "TestMethod", 19, 31, 57 },
                    { 215, "91", 10, true, 1830, "AccessModifier", 18, 90, 57 },
                    { 216, "57", 10, true, 1830, "ReturnType", 17, 50, 57 },
                    { 217, "", 10, true, 1830, "ReturnClass", 16, 1500, 57 },
                    { 218, "0", 2, true, 1830, "ReturnNullable", 15, null, 55 },
                    { 219, "0", 2, true, 1830, "IsAsync", 14, null, 55 },
                    { 220, "0", 2, true, 1830, "IsVirtual", 13, null, 55 },
                    { 221, "0", 2, true, 1830, "IsStatic", 12, null, 55 },
                    { 222, "0", 2, true, 1830, "IsAbstract", 11, null, 55 },
                    { 223, "0", 2, true, 1830, "IsSealed", 10, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 173, "104", 10, true, 1531, "Results", 1, 100, 57 },
                    { 193, "104", 10, true, 1621, "Results", 1, 100, 57 },
                    { 224, "104", 10, true, 1831, "Results", 1, 100, 57 },
                    { 225, "57", 10, true, 1840, "ParamType", 5, 50, 57 },
                    { 226, "", 10, true, 1840, "ParamClass", 4, 1500, 57 },
                    { 227, "1", 2, true, 1840, "IsNullable", 3, null, 55 },
                    { 228, "0", 2, true, 1840, "UseThis", 2, null, 55 }
                });
            ...
            migrationBuilder.InsertData(
                table: "ItemPropertyDefaults",
                columns: new[] { "Id", "DefaultValue", "EditorTypeId", "IsVisible", "ItemTypeId", "Key", "Rank", "ReferenceItemTypeId", "ValueDataTypeId" },
                values: new object[] { 229, "104", 10, true, 1841, "Results", 1, 100, 57 });
