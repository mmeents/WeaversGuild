  ...
  public static class ItemPropertyDefaultsExt {
    ...
    public static Dictionary<WeItemType, List<ItemPropertyDefault>> DefaultProps = new() {
      ...
      },
      {
        ...
        new List<ItemPropertyDefault>(){
            new() {Rank = 1, Key = Cx.ItFilePath, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.FileName },
            new() {Rank = 2, Key = Cx.ItFileExt, DefaultValue = ".html", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String }
        }
      },
      ...
      },
      {
        ...
        new List<ItemPropertyDefault>(){
            new() {Rank = 1, Key = Cx.ItFilePath, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.FileName },
            new() {Rank = 2, Key = Cx.ItFileExt, DefaultValue = ".json", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String }
        }
      },
      ...
      },
      {
        ...
        new List<ItemPropertyDefault>(){
            new() {Rank = 1, Key = Cx.ItFilePath, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.FileName },
            new() {Rank = 2, Key = Cx.ItFileExt, DefaultValue = ".png", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String }
        }
      },
      ...
      },
      {
        ...
        new List<ItemPropertyDefault>() {          
          new() {Rank = 2, Key = Cx.ItRegisterObject, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.LibraryModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
      ...
      },
      {
        ...
        new List<ItemPropertyDefault>(){
          ...
          new() {Rank = 2, Key = Cx.ItNamespaceRoot, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          new() {Rank = 3, Key = Cx.ItTargetFramework, DefaultValue = "net9.0", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          ...
          new() {Rank = 5, Key = Cx.ItImplicitUsing, DefaultValue = "1", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean},
          ...
          new() {Rank = 7, Key = Cx.ItAssemblyVersion, DefaultValue = "1.0.0.0", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          new() {Rank = 8, Key = Cx.ItFileVersion, DefaultValue = "1.0.0.0", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },          
          new() {Rank = 9, Key = Cx.ItIsTestLibrary, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean },
          new() {Rank = 10, Key = Cx.ItFileExt, DefaultValue = ".csproj", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.Hidden },
        }
      },
      ...
      { 
        WeItemType.LibPackageRefModel, new List<ItemPropertyDefault>() {          
          new() {Rank = 2, Key = Cx.ItPackageInclude, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          new() {Rank = 3, Key = Cx.ItPackageVersion, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          ...
          new() {Rank = 5, Key = Cx.ItIncludeAssets, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },          
        } 
      },
      {
      ...
      },
      {
        ...
        new List<ItemPropertyDefault>(){
          new() {Rank = 1, Key = Cx.ItFilePath, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          new() {Rank = 2, Key = Cx.ItFileExt, DefaultValue = ".cs", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.Hidden },
      ...
      {WeItemType.DiImportModel,
        new List<ItemPropertyDefault>() {
          new() {Rank = 1, Key = Cx.ItLifetimeScope, DefaultValue=WeItemType.CSLifetimeScoped.AsIntString(), ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.CSharpLifetimes, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
...
/*
     ...
     { WeItemType.InterfaceDocs, new List<ItemPropertyDefault>() {
      ...
      { WeItemType.RecordModel,
        new List<ItemPropertyDefault>() {
          new() { Rank = 11, Key = Cx.ItAccessModifier, DefaultValue = WeItemType.WePublic.AsIntString(), ValueDataTypeId=(int)WeDataType.Int,  ReferenceItemTypeId =(int) WeItemType.AccessibilityLookups, EditorTypeId =(int) WeEditorType.LookupTypeEditor},
          ...
          new() { Rank = 15, Key = Cx.ItBaseType, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.CSharpTypes, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank = 16, Key = Cx.ItInterface, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.ClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor }          
        }
      },
      ...
      { WeItemType.ClassModel,
        new List<ItemPropertyDefault>()  {
          new() { Rank = 11, Key = Cx.ItTestClassAttribute, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId =(int) WeEditorType.Boolean},
          new() { Rank = 11, Key = Cx.ItAccessModifier, DefaultValue = WeItemType.WePublic.AsIntString(), ValueDataTypeId=(int)WeDataType.Int,  ReferenceItemTypeId =(int) WeItemType.AccessibilityLookups, EditorTypeId =(int) WeEditorType.LookupTypeEditor},
          new() { Rank = 12, Key = Cx.ItFileExt, DefaultValue = ".cs", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.Hidden },
          new() { Rank = 13, Key = Cx.ItFilePath, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          new() { Rank = 14, Key = Cx.ItNamespace, DefaultValue = "", ValueDataTypeId=(int)WeDataType.StrAscii, EditorTypeId=(int)WeEditorType.String },
          new() { Rank = 15, Key = Cx.ItBaseType, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.ClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank = 16, Key = Cx.ItGenerateInterface, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean },
      ...
      { WeItemType.ClassImportModel, 
        new List<ItemPropertyDefault>() {
          new() {Rank = 2, Key = Cx.ItImportObject, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.ClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
      ...
      { WeItemType.ClassPropertyModel,
        new List<ItemPropertyDefault>() {
          new() { Rank=1, Key = Cx.ItPropertyDataType, DefaultValue = WeItemType.CSharpIntType.AsIntString(), ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.CSharpTypes, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
      ...
      { WeItemType.ClassMethodModel,
        new List<ItemPropertyDefault>() {
          new() { Rank=10, Key = Cx.ItTestMethodAttribute, DefaultValue = WeItemType.NoTestAttribute.AsIntString(), ValueDataTypeId=(int)WeDataType.Int,  ReferenceItemTypeId =(int) WeItemType.TestMethodTypes, EditorTypeId =(int) WeEditorType.LookupTypeEditor},
          new() { Rank=11, Key = Cx.ItAccessModifier, DefaultValue = WeItemType.WePublic.AsIntString(), ValueDataTypeId=(int)WeDataType.Int,  ReferenceItemTypeId =(int) WeItemType.AccessibilityLookups, EditorTypeId =(int) WeEditorType.LookupTypeEditor},
          new() { Rank=12, Key = Cx.ItReturnDataType, DefaultValue = WeItemType.CSharpIntType.AsIntString(), ValueDataTypeId =(int)WeDataType.Int, ReferenceItemTypeId =(int)WeItemType.CSharpTypes, EditorTypeId =(int)WeEditorType.LookupTypeEditor },
          new() { Rank=13, Key = Cx.ItReturnClassType, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.ClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank=14, Key = Cx.ItReturnNullable, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean },
          new() { Rank=15, Key = Cx.ItIsAsync, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean  },
          new() { Rank=16, Key = Cx.ItIsVirtual, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean  },
          new() { Rank=17, Key = Cx.ItIsStatic, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean  },
          new() { Rank=18, Key = Cx.ItIsAbstract, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean  },
          new() { Rank=19, Key = Cx.ItIsSealed, DefaultValue = "0", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean  },
        }
      },
      ...
      { WeItemType.ClassMethodParameterModel,
          new List<ItemPropertyDefault>() {
              new() { Rank=1, Key = Cx.ItParameterDataType, DefaultValue = WeItemType.CSharpIntType.AsIntString(), ValueDataTypeId =(int) WeDataType.Int, ReferenceItemTypeId =(int) WeItemType.CSharpTypes, EditorTypeId =(int) WeEditorType.LookupTypeEditor },
              new() { Rank=2, Key = Cx.ItParameterClassType, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.ClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
              new() { Rank=3, Key = Cx.ItIsNullable, DefaultValue = "1", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean },
      ...
      { WeItemType.EntityPropertyModel, new List<ItemPropertyDefault>() {
          ...
          new() { Rank=7, Key = Cx.ItMaxSize, DefaultValue = "-1", ValueDataTypeId=(int)WeDataType.Int, EditorTypeId=(int)WeEditorType.Integer },
        }
      },
      ...
      { WeItemType.EntityNavigationModel, new List<ItemPropertyDefault>() {
          new() { Rank=2, Key = Cx.ItPropertyClassType, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.EntityClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank=3, Key = Cx.ItHasNavigation, DefaultValue = WeItemType.NavHasOneToMany.AsIntString(), ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.NavigationTypes, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
      ...
      { 
        WeItemType.EntityInboundNavigationModel, new List<ItemPropertyDefault>() {
          new() { Rank=2, Key = Cx.ItPropertyClassType, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.EntityClassModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank=3, Key = Cx.ItForeignKey, DefaultValue = "", ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.EntityPropertyModel, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank=4, Key = Cx.ItHasNavigation, DefaultValue = WeItemType.NavHasManyToOne.AsIntString(), ValueDataTypeId=(int)WeDataType.Int, ReferenceItemTypeId=(int)WeItemType.NavigationTypes, EditorTypeId=(int)WeEditorType.LookupTypeEditor },
          new() { Rank=5, Key = Cx.ItIsNullable, DefaultValue = "1", ValueDataTypeId=(int)WeDataType.Boolean, EditorTypeId=(int)WeEditorType.Boolean },
