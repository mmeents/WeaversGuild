...
namespace TheLoomApp.Extensions {
  public static class StorytimeExts {
    ...
    public static async Task AddStory(this TreeView _tv, IStorytimeService _storytimeService, string name, string description, int povTypeId, int sceneCount) {
      ItemNode? _selectedNode = _tv.SelectedNode as ItemNode;
      var item = _selectedNode?.Item;
      if (_selectedNode == null || item == null
      ...
      var newSubItem = await _storytimeService.AddStory(item, name, description, povTypeId, sceneCount);
      if (newSubItem == null) { return; }
      _tv.AddNewItem(newSubItem);
    }

    public static async Task AddScene(this TreeView _tv, IStorytimeService _storytimeService, string name, string description, int povTypeId, string entryState, string exitState) {
      ItemNode? _selectedNode = _tv.SelectedNode as ItemNode;
      var item = _selectedNode?.Item;
      if (_selectedNode == null || item == null
      ...
      var newSubItem = await _storytimeService.AddScene(item, name, description, povTypeId, entryState, exitState);
      if (newSubItem == null) { return; }
      _tv.AddNewItem(newSubItem);
    }

    public static async Task AddBeat(this TreeView _tv, IStorytimeService _storytimeService, string name, string description) {
      ItemNode? _selectedNode = _tv.SelectedNode as ItemNode;
      var item = _selectedNode?.Item;
      if (_selectedNode == null || item == null
      ...
      var newSubItem = await _storytimeService.AddBeat(item, name, description);
      if (newSubItem == null) { return; }
      _tv.AddNewItem(newSubItem);
    }

    public static async Task AddCallSheet(this TreeView _tv, IStorytimeService _storytimeService, string name, string description) {
      ItemNode? _selectedNode = _tv.SelectedNode as ItemNode;
      var item = _selectedNode?.Item;
      if (_selectedNode == null || item == null
      ...
      var newSubItem = await _storytimeService.AddCallSheet(item, name, description);
      if (newSubItem == null) { return; }
      _tv.AddNewItem(newSubItem);
    }
    ...
    public static async Task AddObserved(this TreeView _tv, IStorytimeService _storytimeService, string name, string description) {
      ItemNode? _selectedNode = _tv.SelectedNode as ItemNode;
      var item = _selectedNode?.Item;
      if (_selectedNode == null || item == null
      ...
      var newSubItem = await _storytimeService.AddObservation(item, name, description);
      if (newSubItem == null) { return; }
      _tv.AddNewItem(newSubItem);
    }
